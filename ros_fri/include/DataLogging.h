...
public:
    //  ---------------------- Doxygen info ----------------------
    //! \fn DataLogging(const char *RobotName, const char *LoggingPath, const char *LoggingFileName, const unsigned int
    //! &MaxNumberOfEntries)
    //!
    //! \brief
    //! Constructor
    ...
    //  ----------------------------------------------------------
    DataLogging(const char* RobotName, const char* LoggingPath, const char* LoggingFileName,
...
protected:
    ...
    //!
    //! \brief
    //! A pointer to an array of \c char values containing the complete current output file (incl. date and time) name
    //! and its directory
    //  ----------------------------------------------------------
