...
public:
    ...
    {
        return (
            (RMLFlags::operator==(Flags)) &&
            (this->BehaviorAfterFinalStateOfMotionIsReached == Flags.BehaviorAfterFinalStateOfMotionIsReached) &&
            (this->KeepCurrentVelocityInCaseOfFallbackStrategy == Flags.KeepCurrentVelocityInCaseOfFallbackStrategy));
    }
