...
public:
    //  ---------------------- Doxygen info ----------------------
    //! \fn ReflexxesAPI(const unsigned int &DegreesOfFreedom, const double &CycleTimeInSeconds, const unsigned int
    //! &NumberOfAdditionalThreads = 0)
    //!
    //! \brief
    ...
    //  ----------------------------------------------------------
    ReflexxesAPI(const unsigned int& DegreesOfFreedom, const double& CycleTimeInSeconds,
    ...
    //  ---------------------- Doxygen info ----------------------
    //! \fn int RMLPosition(const RMLPositionInputParameters &InputValues, RMLPositionOutputParameters *OutputValues, const
    ...
    //! <b><a href="http://www.springer.com/978-3-642-05174-6" target="_blank" title="You may order your personal copy at
    ...
    //  ----------------------------------------------------------
    int RMLPosition(const RMLPositionInputParameters& InputValues, RMLPositionOutputParameters* OutputValues,
    ...
    //  ---------------------- Doxygen info ----------------------
    //! \fn int RMLVelocity(const RMLVelocityInputParameters &InputValues, RMLVelocityOutputParameters *OutputValues,
    ...
    //! \sa \ref page_SynchronizationBehavior
    //  ----------------------------------------------------------
    int RMLVelocity(const RMLVelocityInputParameters& InputValues, RMLVelocityOutputParameters* OutputValues,
                    const RMLVelocityFlags& Flags);
