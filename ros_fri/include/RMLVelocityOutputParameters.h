...
public:
    ...
    //! \sa GetPositionValuesAtTargetVelocityElement(double *OutputValue, const unsigned int &Index) const
    //  ----------------------------------------------------------
    inline void GetPositionValuesAtTargetVelocity(double* OutputVector, const unsigned int& SizeInBytes) const
    {
        memcpy((void*)OutputVector, (void*)this->PositionValuesAtTargetVelocity->VecData, SizeInBytes);
    }
    ...
    //  ----------------------------------------------------------
    inline void GetPositionValuesAtTargetVelocityElement(double* OutputValue, const unsigned int& Index) const
    {
