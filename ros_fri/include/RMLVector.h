...
public:
    ...
    RMLVector(const unsigned int Size)
    {
        ...
        memset(this->VecData, 0x0, (this->VectorDimension * sizeof(T)));
    }
    ...
    //  ---------------------- Doxygen info ----------------------
    //! \fn RMLVector(const T &Component0, const T &Component1, const T &Component2, const T &Component3, const T
    //! &Component4, const T &Component5)
    //!
    //! \brief
    ...
    //  ---------------------- Doxygen info ----------------------
    //! \fn RMLVector(const T &Component0, const T &Component1, const T &Component2, const T &Component3, const T
    //! &Component4, const T &Component5, const T &Component6)
    //!
    //! \brief
    ...
    //  ----------------------------------------------------------
    RMLVector(const T& Component0, const T& Component1, const T& Component2, const T& Component3, const T& Component4,
              const T& Component5, const T& Component6)
    {
    ...
    {
        memcpy((void*)(this->VecData), (void*)(Vector.VecData), (this->VectorDimension * sizeof(T)));
