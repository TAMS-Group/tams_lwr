...
public:
    ...
    RMLOutputParameters& operator=(const RMLOutputParameters& OP)
    {
        ...
        OP.GetPositionalExtrema(this->MinPosExtremaPositionVectorOnly, this->MaxPosExtremaPositionVectorOnly);

        for (i = 0; i < this->NumberOfDOFs; i++)
        {
            OP.GetMotionStateAtMinPosForOneDOF(i, (this->MinPosExtremaPositionVectorArray)[i],
                                               (this->MinPosExtremaVelocityVectorArray)[i],
                                               (this->MinPosExtremaAccelerationVectorArray)[i]);

            OP.GetMotionStateAtMaxPosForOneDOF(i, (this->MaxPosExtremaPositionVectorArray)[i],
    ...
    //! \sa GetNewPositionVectorElement(double *OutputValue, const unsigned int &Index) const
    //  ----------------------------------------------------------
    inline void GetNewPositionVector(double* OutputVector, const unsigned int& SizeInBytes) const
    {
        memcpy((void*)OutputVector, (void*)this->NewPositionVector->VecData, SizeInBytes);
    }
    ...
    //  ----------------------------------------------------------
    inline void GetNewPositionVectorElement(double* OutputValue, const unsigned int& Index) const
    {
    ...
    //! \sa GetNewVelocityVectorElement(double *OutputValue, const unsigned int &Index) const
    //  ----------------------------------------------------------
    inline void GetNewVelocityVector(double* OutputVector, const unsigned int& SizeInBytes) const
    {
        memcpy((void*)OutputVector, (void*)this->NewVelocityVector->VecData, SizeInBytes);
    }
    ...
    //  ----------------------------------------------------------
    inline void GetNewVelocityVectorElement(double* OutputValue, const unsigned int& Index) const
    {
    ...
    //! \sa GetNewAccelerationVectorElement(double *OutputValue, const unsigned int &Index) const
    //  ----------------------------------------------------------
    inline void GetNewAccelerationVector(double* OutputVector, const unsigned int& SizeInBytes) const
    {
        memcpy((void*)OutputVector, (void*)this->NewAccelerationVector->VecData, SizeInBytes);
    }
    ...
    //  ----------------------------------------------------------
    inline void GetNewAccelerationVectorElement(double* OutputValue, const unsigned int& Index) const
    {
    ...
    //  ---------------------- Doxygen info ----------------------
    //! \fn inline void GetPositionalExtrema(RMLDoubleVector *MinimumPositionVector, RMLDoubleVector
    //! *MaximumPositionVector) const
    //!
    //! \brief
    ...
    //!
    //! \sa GetPositionalExtrema(double *MinimumPositionVector, double *MaximumPositionVector, const unsigned int
    //! &SizeInBytes) const \sa RMLVector \sa RMLDoubleVector
    //  ----------------------------------------------------------
    ...
    //  ---------------------- Doxygen info ----------------------
    //! \fn inline void GetPositionalExtrema(double *MinimumPositionVector, double *MaximumPositionVector, const
    ...
    //  ----------------------------------------------------------
    inline void GetPositionalExtrema(double* MinimumPositionVector, double* MaximumPositionVector,
                                     const unsigned int& SizeInBytes) const
    {
        memcpy((void*)MinimumPositionVector, (void*)(this->MinPosExtremaPositionVectorOnly->VecData), SizeInBytes);

        memcpy((void*)MaximumPositionVector, (void*)(this->MaxPosExtremaPositionVectorOnly->VecData), SizeInBytes);
    }
    ...
    //! \sa GetPositionalExtrema(RMLDoubleVector *MinimumPositionVector, RMLDoubleVector *MaximumPositionVector) const
    //! \sa GetPositionalExtrema(double *MinimumPositionVector, double *MaximumPositionVector, const unsigned int
    //! &SizeInBytes) const \sa RMLDoubleVector
    //  ----------------------------------------------------------
    ...
    //  ----------------------------------------------------------
    inline void GetTimesAtMinPosition(double* ExtremaTimes, const unsigned int& SizeInBytes) const
    {
        memcpy((void*)ExtremaTimes, (void*)(this->MinExtremaTimesVector->VecData), SizeInBytes);
    }
    ...
    //  ----------------------------------------------------------
    inline void GetTimesAtMaxPosition(double* ExtremaTimes, const unsigned int& SizeInBytes) const
    {
        memcpy((void*)ExtremaTimes, (void*)(this->MaxExtremaTimesVector->VecData), SizeInBytes);
    }

    //  ---------------------- Doxygen info ----------------------
    //! \fn inline int GetMotionStateAtMinPosForOneDOF(const unsigned int &DOF, RMLDoubleVector *PositionVector,
    //! RMLDoubleVector *VelocityVector, RMLDoubleVector *AccelerationVector) const
    //!
    //! \brief
    ...
    //!
    //! \sa GetMotionStateAtMaxPosForOneDOF(const unsigned int &DOF, RMLDoubleVector *PositionVector, RMLDoubleVector
    //! *VelocityVector, RMLDoubleVector *AccelerationVector) const \sa GetMotionStateAtMinPosForOneDOF(const unsigned int
    //! &DOF, double *PositionVector, double *VelocityVector, double *AccelerationVector, const unsigned int &SizeInBytes)
    //! const \sa GetTimesAtMinPosition(RMLDoubleVector *ExtremaTimes) const \sa GetPositionalExtrema(RMLDoubleVector
    //! *MinimumPositionVector, RMLDoubleVector *MaximumPositionVector) const \sa RMLDoubleVector
    //  ----------------------------------------------------------
    inline int GetMotionStateAtMinPosForOneDOF(const unsigned int& DOF, RMLDoubleVector* PositionVector,
    ...
    //  ---------------------- Doxygen info ----------------------
    //! \fn inline int GetMotionStateAtMinPosForOneDOF(const unsigned int &DOF, double *PositionVector, double
    //! *VelocityVector, double *AccelerationVector, const unsigned int &SizeInBytes) const
    //!
    //! \brief
    //! Copies the motion state, at which the position of the degree of freedom
    //! with the index \c DOF has reached its minimum, to the three referred
    ...
    //!  - RMLOutputParameters::RETURN_SUCCESS, else
    //!
    //! \sa GetMotionStateAtMinPosForOneDOF(const unsigned int &DOF, RMLDoubleVector *PositionVector, RMLDoubleVector
    //! *VelocityVector, RMLDoubleVector *AccelerationVector) const \sa GetMotionStateAtMaxPosForOneDOF(const unsigned int
    //! &DOF, double *PositionVector, double *VelocityVector, double *AccelerationVector, const unsigned int &SizeInBytes)
    //! const \sa GetTimesAtMinPosition(RMLDoubleVector *ExtremaTimes) const \sa GetPositionalExtrema(RMLDoubleVector
    //! *MinimumPositionVector, RMLDoubleVector *MaximumPositionVector) const \sa RMLDoubleVector
    //  ----------------------------------------------------------
    inline int GetMotionStateAtMinPosForOneDOF(const unsigned int& DOF, double* PositionVector, double* VelocityVector,
                                               double* AccelerationVector, const unsigned int& SizeInBytes) const
    {
        if (DOF >= this->NumberOfDOFs)
        {
            return (RMLOutputParameters::RETURN_ERROR);
        ...
        memcpy((void*)PositionVector, (void*)(((this->MinPosExtremaPositionVectorArray)[DOF])->VecData), SizeInBytes);

        memcpy((void*)VelocityVector, (void*)(((this->MinPosExtremaVelocityVectorArray)[DOF])->VecData), SizeInBytes);

        memcpy((void*)AccelerationVector, (void*)(((this->MinPosExtremaAccelerationVectorArray)[DOF])->VecData),
               SizeInBytes);
    ...
    //  ---------------------- Doxygen info ----------------------
    //! \fn inline int GetMotionStateAtMaxPosForOneDOF(const unsigned int &DOF, RMLDoubleVector *PositionVector,
    //! RMLDoubleVector *VelocityVector, RMLDoubleVector *AccelerationVector) const
    //!
    //! \brief
    //! Copies the motion state, at which the position of the degree of freedom
    ...
    //! *VelocityVector, RMLDoubleVector *AccelerationVector) const \sa GetMotionStateAtMaxPosForOneDOF(const unsigned int
    //! &DOF, double *PositionVector, double *VelocityVector, double *AccelerationVector, const unsigned int &SizeInBytes)
    //! const \sa GetTimesAtMaxPosition(RMLDoubleVector *ExtremaTimes) const \sa GetPositionalExtrema(RMLDoubleVector
    //! *MinimumPositionVector, RMLDoubleVector *MaximumPositionVector) const \sa RMLDoubleVector
    //  ----------------------------------------------------------
    inline int GetMotionStateAtMaxPosForOneDOF(const unsigned int& DOF, RMLDoubleVector* PositionVector,
                                               RMLDoubleVector* VelocityVector,
                                               RMLDoubleVector* AccelerationVector) const
    {
        if (DOF >= this->NumberOfDOFs)
    ...
    //  ---------------------- Doxygen info ----------------------
    //! \fn inline int GetMotionStateAtMaxPosForOneDOF(const unsigned int &DOF, double *PositionVector, double
    //! *VelocityVector, double *AccelerationVector, const unsigned int &SizeInBytes) const
    //!
    //! \brief
    //! Copies the motion state, at which the position of the degree of freedom
    ...
    //! *MinimumPositionVector, RMLDoubleVector *MaximumPositionVector) const \sa RMLDoubleVector
    //  ----------------------------------------------------------
    inline int GetMotionStateAtMaxPosForOneDOF(const unsigned int& DOF, double* PositionVector, double* VelocityVector,
                                               double* AccelerationVector, const unsigned int& SizeInBytes) const
    {
        if (DOF >= this->NumberOfDOFs)
        {
        ...
        memcpy((void*)PositionVector, (void*)(((this->MaxPosExtremaPositionVectorArray)[DOF])->VecData), SizeInBytes);

        memcpy((void*)VelocityVector, (void*)(((this->MaxPosExtremaVelocityVectorArray)[DOF])->VecData), SizeInBytes);

        memcpy((void*)AccelerationVector, (void*)(((this->MaxPosExtremaAccelerationVectorArray)[DOF])->VecData),
               SizeInBytes);
    ...
    //! \sa RMLOutputParameters::ExecutionTimes
    //  ----------------------------------------------------------
    inline void GetExecutionTimes(double* OutputVector, const unsigned int& SizeInBytes) const
    {
        memcpy((void*)OutputVector, (void*)this->ExecutionTimes->VecData, SizeInBytes);
    }
    ...
    //! \sa RMLOutputParameters::ExecutionTimes
    //  ----------------------------------------------------------
    inline void GetExecutionTimesElement(double* OutputValue, const unsigned int& Index) const
    {
    ...
    //!  - GetPositionalExtrema(double *MinimumPositionVector, double *MaximumPositionVector, const unsigned int
    //!  &SizeInBytes) const\n\n
    //  ----------------------------------------------------------
    ...
    //! \details
    //! This attribute can be accessed directly or by using one of the following methods:\n\n
    //!  - GetMotionStateAtMinPosForOneDOF(const unsigned int &DOF, RMLDoubleVector *PositionVector, RMLDoubleVector
    //!  *VelocityVector, RMLDoubleVector *AccelerationVector) const\n\n
    //!  - GetMotionStateAtMinPosForOneDOF(const unsigned int &DOF, double *PositionVector, double *VelocityVector,
    //!  double *AccelerationVector, const unsigned int &SizeInBytes) const\n\n
    //  ----------------------------------------------------------
    ...
    //! \details
    //! This attribute can be accessed directly or by using one of the following methods:\n\n
    //!  - GetMotionStateAtMaxPosForOneDOF(const unsigned int &DOF, RMLDoubleVector *PositionVector, RMLDoubleVector
    //!  *VelocityVector, RMLDoubleVector *AccelerationVector) const\n\n
    //!  - GetMotionStateAtMaxPosForOneDOF(const unsigned int &DOF, double *PositionVector, double *VelocityVector,
    //!  double *AccelerationVector, const unsigned int &SizeInBytes) const\n\n
    //  ----------------------------------------------------------
