...
public:
    ...
    {
        memcpy((void*)this->MaxVelocityVector->VecData, (void*)InputVector,
    ...
    //  ----------------------------------------------------------
    inline void SetMaxVelocityVectorElement(const double& InputValue, const unsigned int& Index)
    {
    ...
    //! \sa GetMaxVelocityVectorElement(double *InputValue, const unsigned int &Index) const
    //  ----------------------------------------------------------
    inline void GetMaxVelocityVector(double* InputVector, const unsigned int& SizeInBytes) const
    {
        memcpy((void*)InputVector, (void*)this->MaxVelocityVector->VecData, SizeInBytes);
    }
    ...
    //  ----------------------------------------------------------
    inline void GetMaxVelocityVectorElement(double* InputValue, const unsigned int& Index) const
    {
    ...
    {
        memcpy((void*)this->TargetPositionVector->VecData, (void*)InputVector,
    ...
    //  ----------------------------------------------------------
    inline void SetTargetPositionVectorElement(const double& InputValue, const unsigned int& Index)
    {
    ...
    //! \sa GetTargetPositionVectorElement(double *InputValue, const unsigned int &Index) const
    //  ----------------------------------------------------------
    inline void GetTargetPositionVector(double* InputVector, const unsigned int& SizeInBytes) const
    {
        memcpy((void*)InputVector, (void*)this->TargetPositionVector->VecData, SizeInBytes);
    }
    ...
    //  ----------------------------------------------------------
    inline void GetTargetPositionVectorElement(double* InputValue, const unsigned int& Index) const
    {
    ...
    {
        memcpy((void*)this->AlternativeTargetVelocityVector->VecData, (void*)InputVector,
    ...
    //  ----------------------------------------------------------
    inline void SetAlternativeTargetVelocityVectorElement(const double& InputValue, const unsigned int& Index)
    {
    ...
    //! \sa GetAlternativeTargetVelocityVectorElement(double *InputValue, const unsigned int &Index) const
    //  ----------------------------------------------------------
    inline void GetAlternativeTargetVelocityVector(double* InputVector, const unsigned int& SizeInBytes) const
    {
        memcpy((void*)InputVector, (void*)this->AlternativeTargetVelocityVector->VecData, SizeInBytes);
    }
    ...
    //  ----------------------------------------------------------
    inline void GetAlternativeTargetVelocityVectorElement(double* InputValue, const unsigned int& Index) const
    {
    ...
    bool CheckForValidity(void) const
    {
        ...
        double MinimumOrderOfMagnitude = 0.0, MaximumOrderOfMagnitude = 0.0;

        for (i = 0; i < this->NumberOfDOFs; i++)
        {
            if ((this->SelectionVector->VecData)[i])
            {
                if ((this->MaxVelocityVector->VecData[i] <= 0.0) || (this->MaxAccelerationVector->VecData[i] <= 0.0) ||
                    (fabs(this->TargetVelocityVector->VecData[i]) > (this->MaxVelocityVector->VecData)[i]))
                {
                    return (false);
                }
                ...
                else
                {
                    if (((this->MaxAccelerationVector->VecData)[i] >= fabs((this->CurrentPositionVector->VecData)[i])) &&
                        ...
                        ((this->MaxAccelerationVector->VecData)[i] >=
                         fabs((this->CurrentAccelerationVector->VecData)[i])))
                    {
                        MaximumOrderOfMagnitude = (this->MaxAccelerationVector->VecData)[i];
                    }
                    else
                    {
                        if ((fabs((this->CurrentPositionVector->VecData)[i]) >=
                             fabs((this->TargetPositionVector->VecData)[i])) &&
                            (fabs((this->CurrentPositionVector->VecData)[i]) >=
                             fabs((this->CurrentVelocityVector->VecData)[i])) &&
                            (fabs((this->CurrentPositionVector->VecData)[i]) >=
                             fabs((this->CurrentAccelerationVector->VecData)[i])))
                        {
                        ...
                        {
                            if ((fabs((this->TargetPositionVector->VecData)[i]) >=
                                 fabs((this->CurrentVelocityVector->VecData)[i])) &&
                                (fabs((this->TargetPositionVector->VecData)[i]) >=
                                 fabs((this->CurrentAccelerationVector->VecData)[i])))
                            {
